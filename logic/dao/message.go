...
// Add 插入一条消息
func (*messageDao) Add(ctx *ctx.Context, message model.Message) error {
...
func (*messageDao) ListByUserIdAndSequence(ctx *ctx.Context, userId int64, sequence int64) ([]*model.Message, error) {
